...
class __TwigTemplate_ab7d6cb44830c893a265488597801f63 extends Template
{
    private $source;
    private $macros = [];
...
";
   ...
   ";
            ...
            data-default-email=\"";
                // line 62
                (((CoreExtension::getAttribute($this->env, $this->source, $context["actor"], "default_email", [], "array", true, true, false, 62) &&  !(null === (($__internal_compile_7 = $context["actor"]) && is_array($__internal_compile_7) || $__internal_compile_7 instanceof ArrayAccess ? ($__internal_compile_7["default_email"] ?? null) : null)))) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($__internal_compile_8 = $context["actor"]) && is_array($__internal_compile_8) || $__internal_compile_8 instanceof ArrayAccess ? ($__internal_compile_8["default_email"] ?? null) : null), "html", null, true)) : (yield ""));
                yield "\"
            data-alternative-email=\"";
                // line 63
                (((CoreExtension::getAttribute($this->env, $this->source, $context["actor"], "alternative_email", [], "array", true, true, false, 63) &&  !(null === (($__internal_compile_9 = $context["actor"]) && is_array($__internal_compile_9) || $__internal_compile_9 instanceof ArrayAccess ? ($__internal_compile_9["alternative_email"] ?? null) : null)))) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($__internal_compile_10 = $context["actor"]) && is_array($__internal_compile_10) || $__internal_compile_10 instanceof ArrayAccess ? ($__internal_compile_10["alternative_email"] ?? null) : null), "html", null, true)) : (yield ""));
                yield "\"
            ";
                // line 64
                if (((((($__internal_compile_11 = $context["actor"]) && is_array($__internal_compile_11) || $__internal_compile_11 instanceof ArrayAccess ? ($__internal_compile_11["itemtype"] ?? null) : null) == "User") && CoreExtension::getAttribute($this->env, $this->source, ($context["itiltemplate"] ?? null), "isHiddenField", [("_users_id_" . ($context["actortype"] ?? null))], "method", false, false, false, 64)) || (((($__internal_compile_12 = $context["actor"]) && is_array($__internal_compile_12) || $__internal_compile_12 instanceof ArrayAccess ? ($__internal_compile_12["itemtype"] ?? null) : null) == "Group") && CoreExtension::getAttribute($this->env, $this->source, ($context["itiltemplate"] ?? null), "isHiddenField", [("_groups_id_" . ($context["actortype"] ?? null))], "method", false, false, false, 64)))) {
                    // line 65
   ...
   ";
            // line 73
            if ((( !CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 73) &&  !(($__internal_compile_16 = ($context["params"] ?? null)) && is_array($__internal_compile_16) || $__internal_compile_16 instanceof ArrayAccess ? ($__internal_compile_16["template_preview"] ?? null) : null)) && ($context["canassigntome"] ?? null))) {
                // line 74
                yield "      ";
   ...
   ";
            // line 86
            yield "   ";
            $context["safe_item_fields"] = Twig\Extension\CoreExtension::filter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 86), function ($__value__, $__key__) use ($context, $macros) { $context["value"] = $__value__; $context["key"] = $__key__; return (($context["key"] ?? null) != "content"); });
            // line 87
            yield "
   ...
   (function() {
      ...
      actor_select.select2({
         ...
         ajax: {
            ...
            data: function (params) {
               var is_new_item = ";
            // line 294
            yield ((CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 294)) ? ("true") : ("false"));
            yield ";
               return {
                  action: 'getActors',
            ...
            yield ",
                  ...
                  _idor_token: '";
            // line 301
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Session::getNewIDORToken(CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "getType", [], "method", false, false, false, 301), ["users_right" => (($context["users_right"]) ?? ("all"))]), "html", null, true);
            yield "',
                  itiltemplate_class: '";
            // line 302
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["itiltemplate"] ?? null), "getType", [], "method", false, false, false, 302), "html", null, true);
            yield "',
                  itiltemplates_id: ";
            // line 303
            (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["itiltemplate"] ?? null), "fields", [], "any", false, true, false, 303), "id", [], "array", true, true, false, 303) &&  !(null === (($__internal_compile_17 = CoreExtension::getAttribute($this->env, $this->source, ($context["itiltemplate"] ?? null), "fields", [], "any", false, true, false, 303)) && is_array($__internal_compile_17) || $__internal_compile_17 instanceof ArrayAccess ? ($__internal_compile_17["id"] ?? null) : null)))) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((($__internal_compile_18 = CoreExtension::getAttribute($this->env, $this->source, ($context["itiltemplate"] ?? null), "fields", [], "any", false, true, false, 303)) && is_array($__internal_compile_18) || $__internal_compile_18 instanceof ArrayAccess ? ($__internal_compile_18["id"] ?? null) : null), "html", null, true)) : (yield 0));
            yield ",
                  itemtype: '";
            // line 304
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "getType", [], "method", false, false, false, 304), "html", null, true);
            yield "',
                  items_id: ";
            // line 305
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "isNewItem", [], "method", false, false, false, 305)) ? ( -1) : ((($__internal_compile_19 = CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 305)) && is_array($__internal_compile_19) || $__internal_compile_19 instanceof ArrayAccess ? ($__internal_compile_19["id"] ?? null) : null))), "html", null, true);
            yield ",
                  item: ";
            // line 306
      ...
      ";
            // line 422
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["itiltemplate"] ?? null), "isHiddenField", [("_users_id_" . ($context["actortype"] ?? null))], "method", false, false, false, 422)) {
                // line 423
      ...
      ";
            ...
            // line 425
            yield "      ";
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["itiltemplate"] ?? null), "isHiddenField", [("_groups_id_" . ($context["actortype"] ?? null))], "method", false, false, false, 425)) {
                // line 426
...
";
    ...
    {
        return array (  676 => 428,  670 => 426,  667 => 425,  661 => 423,  659 => 422,  650 => 416,  642 => 411,  635 => 407,  627 => 402,  623 => 401,  619 => 400,  614 => 398,  610 => 397,  606 => 396,  572 => 365,  568 => 364,  508 => 307,  504 => 306,  500 => 305,  496 => 304,  492 => 303,  488 => 302,  484 => 301,  479 => 299,  475 => 298,  468 => 294,  460 => 289,  433 => 265,  429 => 264,  425 => 263,  416 => 257,  411 => 255,  391 => 238,  377 => 227,  373 => 226,  369 => 225,  365 => 224,  345 => 207,  325 => 190,  305 => 173,  285 => 155,  276 => 149,  266 => 141,  264 => 140,  255 => 134,  247 => 129,  242 => 127,  237 => 125,  233 => 124,  225 => 119,  220 => 117,  215 => 115,  210 => 113,  205 => 111,  187 => 96,  181 => 93,  173 => 87,  170 => 86,  167 => 76,  161 => 74,  159 => 73,  155 => 71,  146 => 68,  137 => 67,  133 => 65,  131 => 64,  127 => 63,  123 => 62,  119 => 61,  113 => 60,  108 => 59,  105 => 58,  101 => 57,  97 => 56,  90 => 55,  88 => 54,  85 => 53,  81 => 51,  79 => 50,  77 => 49,  75 => 48,  72 => 47,  68 => 45,  66 => 44,  64 => 43,  61 => 42,  57 => 40,  55 => 39,  53 => 38,  50 => 37,  48 => 36,  46 => 35,  43 => 34,  41 => 33,  38 => 32,);
    }
